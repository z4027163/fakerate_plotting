...
void plotFakenew::sbsDistributions(TChain *tC,  string sample="bla", string what, string path) {
   ...
   int count0=0; int count1=0, count2=0;
   ...
   for (unsigned int i=0; i < n; ++i){
     ...
     for (unsigned int bhad=0; bhad < nV0; ++bhad){
       ...
       if(string::npos != sample.find("ks") && string::npos != sample.find("DoubleMuMu")){ 
           ...
           //cout << "htl pt is: " << MuonId_hlt_pt[V0_trk1_mu_index[bhad]] << endl;
           //cout << "muon pt is: " << Muon_pt[V0_trk1_mu_index[bhad]] << endl;   
           /*if (V0_trk1_mu_index[bhad] >= 0 && nMuon==3) { 
               cout << "Kaon Muon index is : " << V0_trk1_mu_index[bhad] << endl;
               cout << "Pt of muon #1 is   : " << Muon_pt[0];
               cout << "Pt of muon #2 is   : " << Muon_pt[1];
               cout << "Pt of muon #3 is   : " << Muon_pt[2];    
           }*/
...
*/
   ...
   TString new_filename= Form("%s/histo_WDY_%s.root",path.c_str(), sample.c_str());
 ...
 // ----------------------------------------------------------------------
void plotFakenew::loopOverChain(TChain *tC, string basic="Data", string modf="noprod", string path="ks/"){
...
void plotFakenew::list_dir_file(TChain *tC, string filename) {
 ...
 int main()
 {
   ...
   c1.loopOverChain(tC_22, "Data_521_2022_ks_slxy3_lxy8","Histproduction", "ks/");
   delete tC_22; 

   plotFakenew c2;
   TChain* tC_22_MC= new TChain("Events");                                                                                                                   c2.list_dir_file(tC_22_MC, "2022_MC_ks.txt");                                                                                                             cout<<"Entry MC "<<tC_22_MC->GetEntries()<<endl;                                                                                                       
   c2.loopOverChain(tC_22_MC, "MC_516_2022_ks_slxy3_lxy8","Histproduction_MC", "ks/");
   delete tC_22_MC;
...
*/
   ...
   c3.loopOverChain(tC_22_DoubleMuMu, "Data_521_2022_ks_DoubleMuMu_slxy3_lxy8", "Histproduction", "ks_DoubleMuMu/");
